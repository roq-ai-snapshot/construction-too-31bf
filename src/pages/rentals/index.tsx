  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'tool', 'invoice.count'],
  ...
  const columns: ColumnType[] = [
    {
      id: 'rent_start',
      header: 'Rent Start',
      accessorKey: 'rent_start',
      cell: ({ row: { original: record } }: any) =>
        record?.rent_start ? format(record?.rent_start, 'dd-MM-yyyy') : '',
    },
    {
      id: 'rent_end',
      header: 'Rent End',
      accessorKey: 'rent_end',
      cell: ({ row: { original: record } }: any) => (record?.rent_end ? format(record?.rent_end, 'dd-MM-yyyy') : ''),
    },
